...
def banner():
	print('''%s
     H)    hh K)   kk  R)rrrrr       A)aa   F)ffffff R)rrrrr  I)iiii D)dddd   I)iiii 
H)    hh K)  kk   R)    rr     A)  aa  F)       R)    rr   I)   D)   dd    I)   
H)hhhhhh K)kkk    R)  rrr     A)    aa F)fffff  R)  rrr    I)   D)    dd   I)   
H)    hh K)  kk   R) rr       A)aaaaaa F)       R) rr      I)   D)    dd   I)   
H)    hh K)   kk  R)   rr     A)    aa F)       R)   rr    I)   D)    dd   I)   
H)    hh K)    kk R)    rr    A)    aa F)       R)    rr I)iiii D)ddddd  I)iiii                                               
"""%(N))                                                    
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Name       : Hacker Afridi
 [\x1b[1;96m+%s] Github      : https://github.com/x
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
def kontol():
    os.system("clear")
    print(f""" 
